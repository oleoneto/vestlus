...
class PrivateMessage(Message):
    ...
    class Meta:
        db_table = 'leh_private_messages'
        indexes = [models.Index(fields=['created_at', 'sender', 'receiver', 'parent'])]
...
class GroupMessage(Message):
    ...
    class Meta:
        db_table = 'leh_group_messages'
        indexes = [models.Index(fields=['created_at', 'sender', 'channel'])]
...
class Reaction(models.Model):
    ...
    class Meta:
        db_table = 'leh_message_reactions'
